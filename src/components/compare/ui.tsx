...
import { SparklesCore } from "../sparkles/ui";
...
export const Compare = ({
  ...
  return (
    <div
      ref={sliderRef}
      className={cn("w-full border h-[500px] overflow-hidden", className)}
      style={{
        position: "relative",
    ...
    >
      ...
      <AnimatePresence initial={false}>
        {secondImage ? (
          <motion.img
            className={cn(
              "absolute top-0 left-0 z-[19] flex-shrink-0  rounded-2xl w-full h-full select-none",
              secondImageClassname
            )}
            alt="second image"
            src={secondImage}
